...
export const register = (nome, cognome, email, dataDiNascita, nomeUtente, password, navigate) => {
    return async (dispatch) => {
        try {
            const response = await fetch("http://192.168.1.61:5220/api/Account/register", {
                headers: {
...
export const login = (email, password, navigate) => {
    return async (dispatch) => {
        try {
            const response = await fetch("http://192.168.1.61:5220/api/Account/login", {
                headers: {
                    "Content-Type": "application/json",
                },
                method: "POST",
            ...
            if (response.ok) {
                ...
                const userResponse = await fetch("http://192.168.1.61:5220/api/Account/userLogged", {
                    headers: {
...
export const getUtenti = () => {
    return async (dispatch) => {
        try {
            const response = await fetch("http://192.168.1.61:5220/api/Account/utenti", {
                headers: {
...
export const getAllUtenti = () => {
    return async (dispatch) => {
        try {
            const response = await fetch("http://192.168.1.61:5220/api/Account/utentiGenerali", {
                headers: {
                    Authorization: "Bearer " + localStorage.getItem("jwtToken"),
                    "Content-Type": "application/json",
                },
...
export const getUtente = (id) => {
    return async (dispatch) => {
        try {
            const response = await fetch("http://192.168.1.61:5220/api/Account/utente" + id, {
                headers: {
                    Authorization: "Bearer " + localStorage.getItem("jwtToken"),
                    "Content-Type": "application/json",
                },
...
export const getUtenteLoggato = () => {
    return async (dispatch, navigate) => {
        try {
            const response = await fetch("http://192.168.1.61:5220/api/Account/userLogged", {
                headers: {
                    Authorization: "Bearer " + localStorage.getItem("jwtToken"),
                    "Content-Type": "application/json",
                },
    ...
    return async (dispatch) => {
        try {
            const response = await fetch(
                "http://192.168.1.61:5220/api/Account/nomeUtente",
                {
                    method: "PUT",
                    body: JSON.stringify({
...
export const deleteUtente = (navigate) => {
    return async () => {
        try {
            const response = await fetch("http://192.168.1.61:5220/api/Account/utente", {
                method: "DELETE",
                headers: {
                    Authorization: "Bearer " + localStorage.getItem("jwtToken"),
                },
