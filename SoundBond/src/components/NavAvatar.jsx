  ...
  return (
    <div className="flex items-center">
      <Dropdown
        ...
        className="border-[#b849d6] border-[0.5px] rounded-lg"
      >
        <DropdownTrigger>
        ...
        <DropdownMenu
          ...
          className="flex justify-center bg-[#0c0512]"
        >
          <DropdownItem
            key="profile"
            className="gap-2 border-b-[0.5px] border-[#b849d6] p-2 flex justify-center"
          >
